...
#' 
#' @export
nestSearch <- function(tp,Nside,index_only,plot_points){
...
j_1 <- 3;
h_1 <- nest_search(tp,j_1,-1,0,plt_pnt)
hp_1 <- h_1$p
pix_1 <- h_1$ind
...
# found at level j_1
j_2 <- 7
h_2 <- nest_search(tp,j_2,j_1,pix_1,plt_pnt)
hp_2 <- h_2$p
pix_2 <- h_2$ind
...
# found at level j_2
j_3 <- log2(Nside)
h_3 <- nest_search(tp,j_3,j_2,pix_2,plt_pnt)
hp_3 <- h_3$p
pix_3 <- h_3$ind
